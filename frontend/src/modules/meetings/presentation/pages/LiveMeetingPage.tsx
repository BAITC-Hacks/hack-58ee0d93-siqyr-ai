...
export default function LiveMeetingPage() {
  ...
  return <Stack gap="lg">
    <Group justify="space-between" align="start" gap="lg">
      ...
      {canRecord && <Menu position="bottom-end" shadow="md" withinPortal>
