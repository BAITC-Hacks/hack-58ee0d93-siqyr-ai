    ...
    children: [
      ...
      { path: '*', handle: { access: {} } satisfies SecurityHandle, element: <WorkspaceRedirect /> },
      {
        ...
        children: [
          ...
          { path: 'meetings/live/call', handle: { access: pagePolicies.call } satisfies SecurityHandle, element: <Suspense fallback={pageFallback}><CallPage /></Suspense> },
          { path: 'meetings/live/call/:runId', handle: { access: pagePolicies.call } satisfies SecurityHandle, element: <Suspense fallback={pageFallback}><CallPage /></Suspense> },
