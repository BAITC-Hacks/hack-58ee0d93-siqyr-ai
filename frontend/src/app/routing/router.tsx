    ...
    children: [
      ...
      { path: '*', handle: { access: {} } satisfies SecurityHandle, element: <WorkspaceRedirect /> },
      {
        ...
        children: [
          ...
          { path: 'meetings/live/call/:runId', handle: { access: pagePolicies.liveMeeting } satisfies SecurityHandle, element: <Suspense fallback={pageFallback}><CallPage /></Suspense> },
