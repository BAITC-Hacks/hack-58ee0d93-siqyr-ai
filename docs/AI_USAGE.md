...
- 2026-09-23: Codex добавил личный профиль, настройки, обработку аватара и отзыв локальных JWT при смене пароля; автоматическая проверка: 49 backend-тестов, проверка интерфейса человеком пока не проводилась.
